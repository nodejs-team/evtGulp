...
!function(window, document, undefined){
    ...
    var classExtend = function(dest, source, proto){
        ...
        dest.superClass = source.prototype;
    ...
    Event.prototype = {
        ...
        once: function(eventName, handle, scope){
            this.addEvent(eventName, function handler(){
    ...
    var Timer = function(delay, repeatCount){
        ...
        this.timer = null;
        Timer.superClass.constructor.call(this);
    };
    ...
    var MovieClip = function(resUrl, res, frameKey, el){
        ...
        this._totalFrame = this.frame.frames.length;

        if( this.RESUrl instanceof Array ){
            this._totalFrame = this.RESUrl.length;
        ...
        MovieClip.superClass.constructor.call(this);
    ...
    classExtend(MovieClip, Event, {
        ...
        gotoAndPlay: function(startFrame, playTimes){
            ...
            this._frameCount = startFrame;
            this._playTimes = playTimes;

            if( this._playTimes > 0 ){
                this._repeatCount = this._playTimes*this._totalFrame;
                this._timer.setRepeatCount(this._repeatCount);
            }

            this.setFrame(this._frameCount);
            this.play();
        ...
        setFrameBySprite: function( index ){
            ...
            this._timer.delay = resItem.duration || this.frameRate;
        ...
        _initEvents: function(){
            this._timer.addEvent('timer', function(){
                if( ++this._frameCount > this._totalFrame - 1 ){
                    this._frameCount = this._startFrame;
                }
    ...
    var Resource = (function() {
        ...
        var loadImg = function( src, sucFn, errFn ){
            ...
            src = /^https?:\/\//.test(src) ? src : (Resource.basePath + Resource.baseUrl + src);
            img.src = src;
        };
        ...
        var IMGloader = function(src){
            ...
            IMGloader.superClass.constructor.call(this);
        ...
        var JSONloader = function(url){
            ...
            JSONloader.superClass.constructor.call(this);
        ...
        var getRes = function(resId){
            ...
            if( pathRes ){
                ...
                for(var i = Number(path[0]); i<Number(path[1]) + 1; i++){
                    ...
                    var url = /^https?:\/\//.test(assets[pathId].url) ? assets[pathId].url : (Resource.basePath + Resource.baseUrl + assets[pathId].url);
                    pathGroup.push(url);
                }
            ...
            if( asset.type == 'json' ){
                ...
                return Resource.basePath + Resource.baseUrl + asset.url;
            }
        ...
        var loadGroup = function(groupKey, data){
            ...
            loadGroup.superClass.constructor.call(this);
