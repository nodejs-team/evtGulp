    ...
    function hobYU(callBack) {
        ...
        var HONGBAO = setInterval(function() {
           ...
           /* var HTML_i = $('<i style="background-size:' + _r[parseInt(Math.random() * 4)] + ';top:' + -200+'px; left:' + (parseInt(Math.random() * 20) - isPc) * 20 + '%"><b>+1</b></i>');*/
            ...
            var HTML_i = $('<i style="background: url(https://act.mcake.com/fangli/2022/pc/38jie/images/flower-'+_src[parseInt(Math.random() * 3)]+'.png) center no-repeat;  background-size:' + _r[parseInt(Math.random() * 4)] + ';top:' + -100+'px; left:60%; margin-left:-' + rand + 'px"><b></b></i>');
          ...
          $('.time').html(6 - parseInt(h_con / 2) + 's');  /*600（6秒）/speed(200)=3*/

            if (h_con === 11) {  /* 33*3 = 1000*/
