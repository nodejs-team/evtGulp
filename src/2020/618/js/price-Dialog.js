...
(function () {
  ...
  function SelectShow(ele,d,isShow,n,db,reduce) {
    ...
    if(pondsingle<0){
      ...
      $newprice.html((prices*dis-reduce).toFixed(2));
      ...
      $newprice.html(((prices[n]-reduce)*dis).toFixed(2));
        ...
        $bangshu.find("li").each(function (i) {
          ...
          $(this).click(function () {
            ...
            if(double){ /*第二件半价*/
              ...
              newPrice = totaPrice*dis-reduce*num;
            }
