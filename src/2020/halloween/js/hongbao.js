    ...
    function hobYU(callBack) {
        ...
        var HONGBAO = setInterval(function() {
           ...
           /* var HTML_i = $('<i style="background-size:' + _r[parseInt(Math.random() * 4)] + ';top:' + -200+'px; left:' + (parseInt(Math.random() * 20) - isPc) * 20 + '%"><b>+1</b></i>');*/
            ...
            var HTML_i = $('<i style="background: url(https://act.mcake.com/fangli/2020/pc/halloween/images/pumpkin-'+_src[parseInt(Math.random() * 3)]+'.png) center no-repeat;  background-size:' + _r[parseInt(Math.random() * 4)] + ';top:' + -100+'px; left:80%; margin-left:-' + rand + 'px"><b></b></i>');
