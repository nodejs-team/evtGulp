  ...
  function initNum() {
    ...
    $(".pro-list .row").each(function(i,el){
      ...
      $(this).find(".plus").on('click', function(){
        ...
        $(this).parents(".row").find(".cake-pric-img").attr("src","https://act.mcake.com/fangli/2020/pc/38jie/images/cake-price-"+bs+".png");
      ...
      if(currentItem.ponds.length==1){
        ...
        $(this).find(".cake-pric-img").attr("src","https://act.mcake.com/fangli/2020/pc/38jie/images/cake-price-"+bs+".png");
