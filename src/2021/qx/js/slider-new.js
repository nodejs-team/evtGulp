...
(function () {
  ...
  var url = "https://act.mcake.com/fangli/2021/pc/qx/";
  ...
  function initNum() {
    ...
    $(".pro-list .row").each(function(i,el){
      ...
      $(this).find(".plus").on('click', function(){
        ...
        $(this).parents(".row").find(".dis-priceImg").attr("src","https://act.mcake.com/fangli/2021/pc/qx/images/price-"+totalPrice+".png");
      ...
      if(currentItem.ponds.length==1){
        ...
        $(this).find(".minus").addClass("none");
        $(this).find(".plus").addClass("none");
        ...
        $(this).find(".dis-priceImg").attr("src","https://act.mcake.com/fangli/2021/pc/qx/images/price-"+totalPrice+".png");
        ...
        /*设置默认显示2磅*/
        currentItem.ix=0;/*0是默认显示1磅，1是默认显示第二个磅数*/
