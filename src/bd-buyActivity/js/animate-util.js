(function(window, $, undefined){
  ...
  var jqAnimateMap = {
    ...
    /*新加*/
    "slide-down-l3": function(el, delay, duration, cb){
        ...
        reset();
        setTimeout(doAanimation, delay);

      },
      "slide-down-r3": function(el, delay, duration, cb){
          var $el = $(el);
          var addons = getNoneStaticNodes(el);
          setNoneStaticNodesOpacity(addons, 0);
      ...
      "slide-down-r4": function(el, delay, duration, cb){
          var $el = $(el);
          var addons = getNoneStaticNodes(el);
          setNoneStaticNodesOpacity(addons, 0);
      ...
      "arrow": function(el, delay, duration, cb){
          var $el = $(el);
          var addons = getNoneStaticNodes(el);
          setNoneStaticNodesOpacity(addons, 0);
