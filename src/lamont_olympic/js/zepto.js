...
;(function($){
  ...
  $.fn.dataset = function() {
    ...
    return $.extend({}, dataset, this[0][exp]);
  };
    ...
    return value === undefined ?
      // set multiple values via object
        $.isPlainObject(name) ?
          ...
          // get value from first element
            (0 in this ? getData(this[0], name) || tmpData[name] : undefined) :
      // set value on all elements
        this.each(function(){
          if (name in tmpData) delete this.dataset[name];
