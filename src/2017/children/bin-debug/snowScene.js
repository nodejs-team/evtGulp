var SnowScene = (function (_super) {
    ...
    var d = __define,c=SnowScene,p=c.prototype;
    ...
    p.doAnimate = function (snow, scrollTop) {
    ...
    p.setAnimates = function (scrollTop) {
...
egret.registerClass(SnowScene,'SnowScene');
