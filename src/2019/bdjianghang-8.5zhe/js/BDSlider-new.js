(function () {
  ...
  function initNum() {
    ...
    $(".products li").each(function(i,el){
      ...
      var weights = $(el).attr('data-weight');
      ...
      $(this).find(".plus").on('click', function(){
        ...
        $(this).parents("li").find(".bang").html(currentItem.ponds[ix]+'/'+currentItem.weights[ix]);
      ...
      if(currentItem.ponds.length==1){
        ...
        oldPrice = totalPrice-0;
        totalPrice = isDiscount(totalPrice,0,discount,zhekou); /*满足条件折扣*/
        $(this).find(".bang").html(currentItem.ponds[0]+'/'+currentItem.weights[0]);
        ...
        $(this).find(".bang").html(currentItem.ponds[1]+'/'+currentItem.weights[1]);
        $(this).find(".dis-price").html(totalPrice.toFixed(2));
        $(this).find(".old-price").html(oldPrice.toFixed(2));
