(function () {
  ...
  function initNum() {
    var items = [];
    $(".s-products li").each(function(i,el){
      ...
      $(this).find(".plus").on('click', function(){
        ...
        $(this).parents("li").find(".p-bs").html(currentItem.ponds[ix]);
        $(this).parents("li").find(".p-weight").html(currentItem.weight[ix]);


        $(this).parents("li").find(".buy_btn").attr("data-sku", currentItem.sku[ix]);
        $(this).parents("li").find(".buy_btn").attr("data-method", currentItem.method[ix]);
        $(this).parents("li").find(".buy_btn").attr("data-pid", currentItem.pid[ix]);
        $(this).parents("li").find(".buy_btn").attr("data-ptype", currentItem.ptype[ix]);
        $(this).parents("li").find(".buy_btn").attr("data-channel", currentItem.channel[ix]);
        $(this).parents("li").find(".buy_btn").attr("data-num", 1);
